import datetime
import json
import ScrapingTweet.function.StringManipulate as sm


def manage(name_file_json):
    posts_string = {}
    i = 0
    with open(f'./ScrapingTweet/json_file/{name_file_json}.json', 'r') as file:
    ...
    # pprint(posts_string)
    with open(f'./ScrapingTweet/json_result/{name_file_json}.json', 'w') as fp:
